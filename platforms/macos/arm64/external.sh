...
cp build/libcargs.dylib ${PPUC_SOURCE_ROOT}/third-party/runtime-libs/macos/arm64/
cd ..
...
cp -a .libs/libserialport.{dylib,*.dylib} ${PPUC_SOURCE_ROOT}/third-party/runtime-libs/macos/arm64
cd ..
...
cp -a build/libsockpp.{dylib,*.dylib} ${PPUC_SOURCE_ROOT}/third-party/runtime-libs/macos/arm64/
cd ..
